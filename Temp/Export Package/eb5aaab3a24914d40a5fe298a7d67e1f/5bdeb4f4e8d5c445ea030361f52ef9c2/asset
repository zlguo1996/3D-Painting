Shader "VTP/Specular/2 Texture Blend (Advanced)" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
			...
			if( (IN.flowUV.x == 0 && IN.flowUV.y == 0) || (_useFlowMap2 == 0 ) || _useFlowMapGlobal == 0 ) {
				...
				//Metallic
				_specular =  correctionFactor * ( _Specular * tex2Dlod (_SpecularTex, float4(IN.uv_MainTex,0,mipL1)).rgb * factorRed + _Specular2 * tex2Dlod (_SpecularTex2, float4(IN.uv_MainTex2,0,mipL2)).rgb * factorGreen );
				...
				fixed3 normal2 = ( normalDataRed + normalDataGreen2 );  
           		...
           		if( _flowOnlyNormal == 1 ) {
					...
					//Metallic
					fixed3 specular1 = ( _Specular * tex2Dlod (_SpecularTex, float4(IN.uv_MainTex,0,mipL1)).rgb * factorRed +  _Specular2 * tex2Dlod (_SpecularTex2, float4(flowUV2_phase0,0,mipL2)).rgb * factorGreen  );  
			        fixed3 specular2 = ( _Specular * tex2Dlod (_SpecularTex, float4(IN.uv_MainTex,0,mipL1)).rgb * factorRed +  _Specular2 * tex2Dlod (_SpecularTex2, float4(flowUV2_phase1,0,mipL2)).rgb * factorGreen  );  
	...
	FallBack "Diffuse"
	CustomEditor "ShaderEditorSpecular2Tex"
}
