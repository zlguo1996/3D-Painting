...
[ExecuteInEditMode]
public class VT_EA_window : EditorWindow {
	...
	public static void LaunchVT_EA_window() {

		var win = EditorWindow.GetWindow<VT_EA_window> (false, "VertexToolsPro - Early Access", true);
		win.generateStyles ();
