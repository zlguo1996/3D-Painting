...
public class ShaderEditor_Spec_Tesselation_V2 : ShaderGUI
{
	[SerializeField]
...
//	private bool useParallaxOfR3 = false;
	...
	[SerializeField]
	private bool showTesselationSettings = false;
	...
	void guiForRedChannel() {
		...
		matEditor.TexturePropertySingleLine (new GUIContent ("Specular Map"), getProperty ("_SpecularTex"));
	...
	void guiForGreenChannel() {
		...
		matEditor.TexturePropertySingleLine (new GUIContent ("Specular Map"), getProperty ("_SpecularTex2"));
		...
		matEditor.RangeProperty (getProperty ("_TesselationStrength2"), "Tesselation Strength");
	...
	void guiForBlueChannel() {
		...
		matEditor.TexturePropertySingleLine (new GUIContent ("Specular Map"), getProperty ("_SpecularTex3"));
		...
		matEditor.RangeProperty (getProperty ("_TesselationStrength3"), "Tesselation Strength");
